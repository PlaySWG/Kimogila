...
public class MessageEncryption {
	...
	public static byte[] encrypt(byte[] data, int crcSeed) { return encryptWithCRC(data, crcSeed, true); }
	public static byte[] decrypt(byte[] data, int crcSeed) { return encryptWithCRC(data, crcSeed, false); }
	private static byte[] encryptWithCRC(byte[] data, int crcSeed, boolean out) {
		// TODO: Make it use an exisiting buffer
		int startingIndex = 2;
